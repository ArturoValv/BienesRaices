...
class ComposerAutoloaderInit51a0ae41f8f9b6ccf9bbd4697412e6d6
{
    ...
    public static function getLoader()
    {
        ...
        $includeFiles = \Composer\Autoload\ComposerStaticInit51a0ae41f8f9b6ccf9bbd4697412e6d6::$files;
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire51a0ae41f8f9b6ccf9bbd4697412e6d6($fileIdentifier, $file);
        }
 ...
 * @return void
 */
function composerRequire51a0ae41f8f9b6ccf9bbd4697412e6d6($fileIdentifier, $file)
{
